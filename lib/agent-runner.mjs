...
export function runAgent(role, request = {}) {
  ...
  // Persist usage before emitting a potentially huge captured narrative. A parent that enforces an
  // output cap may terminate the child while stdout is draining; the completed agent call must not
  // disappear from the ledger in that case.
