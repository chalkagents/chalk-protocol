...
export const DEFAULT_VERIFICATION_TIMEOUT_MS = 15 * 60 * 1000;
...
export function runToolchain(root, verifyConfig = {}, { runner = '', mode = 'task', timeoutMs = DEFAULT_VERIFICATION_TIMEOUT_MS, runDir, receiptPath, storage, proto = {}, monitorSource, onResult = () => {} } = {}) {
  const results = [];
