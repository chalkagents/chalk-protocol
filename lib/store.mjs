...
import { existsSync, mkdirSync, readFileSync, writeFileSync, appendFileSync, statSync, realpathSync, openSync, writeSync, closeSync, unlinkSync, renameSync, readdirSync } from 'node:fs';
